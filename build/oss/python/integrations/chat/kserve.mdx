...
This guide provides a quick overview for getting started with KServe [chat models](/oss/python/langchain/models). Use `langchain-kserve` to connect LangChain apps to models served on KServe, including OpenAI-compatible and V2 protocol endpoints.
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/python/integrations/chat/kserve.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>

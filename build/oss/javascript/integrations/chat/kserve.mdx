...
This guide provides a quick overview for getting started with KServe [chat models](/oss/javascript/langchain/models). Use `@bitkaio/langchain-kserve` to connect LangChain.js apps to models served on KServe, including OpenAI-compatible and V2 protocol endpoints.

## Overview

### Integration details

| Class | Package | Serializable | [PY support](/oss/javascript/integrations/chat/kserve) | Downloads | Version |
| :--- | :--- | :---: | :---: | :---: | :---: |
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/javascript/integrations/chat/kserve.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
